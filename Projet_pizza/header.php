...
<html lang="en">
  <head>
    ...
    <link href="css/grille_perso.css" rel="stylesheet"/>
    ...
    <div class="row">
      <div class="col-sm-1 dropdown" style=" padding-left: 0px;" >
        ...
        <div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="boisson.php">Boisson</a>
        </div>
      </div>
      ...
      <?php } ?>
        <div class="col-sm-1">
          <a href="panier/panier.php"><img src="images/panier.png" alt="panier" class="rounded image_panier" ></a>
        </div> 
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between" style="margin-top: 0px;">
      <a class="offset-md-1 col-sm-2 text-muted" href="pizza.php">Pizza</a>
      <a class="col-sm-2 text-muted" href="calzone.php">Calzone</a>
      <a class="col-sm-2 text-muted" href="dessert.php">Dessert</a>
      <a class="col-sm-2 text-muted" href="boisson.php">Boissons</a>
    </nav>
  </div><br>
</div>
  <!--/Header-->