...
<html lang="fr">
  <head>
    ...
    <!-- Javascript -->
    <script src="../js/traitement_formulaire.js"></script>
    <script src="../js/verif_modif_profil.js"></script>
    ...
    <header class="blog-header" style="padding-bottom: 0px; margin-bottom: 0px; padding-top: 1em;">
      ...
      <?php if(!isset($_SESSION['prenom'])){ ?>
          <div class="offset-sm-2 col-sm-1 d-flex justify-content-end align-items-center">
            <a class="btn btn-sm btn-outline-secondary" href="formulaire_inscription.php">Inscription</a>
          </div>
          <div class="col-sm-1 d-flex justify-content-end align-items-center">
            <a class="btn btn-sm btn-outline-primary" href="formulaire_connexion.php">Connexion</a>
          </div>
      <?php }else{ ?>
          <div class="offset-sm-2 col-sm-2 d-flex justify-content-end align-items-center">
          <a href="page_client.php"><h5><?= Profil . ' ' . $_SESSION['prenom'] ?></h5></a>
          </div>
      <?php } ?>
          <div class="col-sm-1">
